...
inputs = {
  ...
  karpenter_service_account_name       = "karpenter-service-account"  # Replace with  actual service account name
  karpenter_user_assigned_identity_name = "karpenter-identity"  # Replace with  actual UAMI name  
}