...
locals {
  ...
  public_subnets  = slice(cidrsubnets(local.subnets[0], "4", "4", "4", "4", "4", "4", "4"), 0, var.max_zones)
  private_subnets = slice(cidrsubnets(local.subnets[1], "4", "4", "4", "4", "4", "4", "4"), 0, var.max_zones)
